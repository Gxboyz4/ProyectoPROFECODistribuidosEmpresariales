...
export const ContenedorLogin = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
          const response = await fetch(`https://localhost:8443/APIGatewaySupermercados/resources/apisupermercados/supermercados/autenticar/query?correo=${correo}&contrasenia=${password}`);
          if (response.ok) {
